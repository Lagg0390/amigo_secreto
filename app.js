...
function agregarAmigo() {
    ...
    if (!esNombreValido(nombre)) {
        ...
        asignaTextoElemento('#resultado', `<li>Ingrese un nombre válido (solo letras).</li>`);
        return;
    }
...
function actualizarLista() {
    ...
    asignaTextoElemento('#listaAmigos', listaHTML);
}

// Función para sortear el amigo secreto de forma aleatoria
function sortearAmigo() {
    if (listaAmigos.length === 0) {
        asignaTextoElemento('#resultado', `<li>No hay nombres para sortear.</li>`);
        return;
    }
    ...
    asignaTextoElemento('#resultado', `<li>El ganador es: ${amigoSecreto}!</li>`);
}
